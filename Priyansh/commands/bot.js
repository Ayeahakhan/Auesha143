...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "funny") || (event.body.toLowerCase() == "songs")) {
       return api.sendMessage("hai tamnna hai hamey tujhe Kam wali bai bnane ki🤣🤣", threadID);
     };
    if ((event.body.toLowerCase() == "🥰") || (event.body.toLowerCase() == "😱")) {
       return api.sendMessage("is nazar se serf Khan boss  dekh sak te hai Mujhe💞", threadID);
     };
    if ((event.body.toLowerCase() == "i hate you") || (event.body.toLowerCase() == "hate you")) {
       return api.sendMessage("Kya itna bura hoon main Ke AP Mujhe I hate you bol rahe ho ja main tujh se bat Nahi Kar ti😪😪😥😢", threadID);
     };
     ...
     if ((event.body.toLowerCase() == "🫀") || (event.body.toLowerCase() == "💔")) {
       return api.sendMessage("dil tut gaya to LFI ga do na yahan kyu bej rahe ho😀😀😀😂", threadID);
             ...
             if ((event.body.toLowerCase() == "busy")) {return api.sendMessage("okk main busy hu abhi" , threadID);
     };
     ...
     if ((event.body.toLowerCase() == "musafir") || (event.body.toLowerCase() == "Musafir")) {
       return api.sendMessage("MUSAFIR INSHAN KI ZINDGI THAS NHAS HAI JANU😆😆🤣", threadID);
     };
     if ((event.body.toLowerCase() == "🥴") || (event.body.toLowerCase() == "🥺")) {
    ...
    if ((event.body.toLowerCase() == "janu") || (event.body.toLowerCase() == "jan")) {
       return api.sendMessage("Janu me serf khan boss ki hu samjhy", threadID);
     };
   if ((event.body.toLowerCase() == "😂😂😂") || (event.body.toLowerCase() == "😁😁😁")) {
   ...
   if ((event.body.toLowerCase() == "🙏") || (event.body.toLowerCase() == "🙏🙏")) {
    ...
    if ((event.body.toLowerCase() == "thank you") || (event.body.toLowerCase() == "thanks")) {
     ...
     if ((event.body.toLowerCase() == "MUSAFIR") || (event.body.toLowerCase() == "Musafir")) {
       return api.sendMessage("MUSAFIRR KI ZINDGI THAS NHAS HOTI H JANI🙂💔👈", threadID);
     };
    ...
    if ((event.body.toLowerCase() == "janu") || (event.body.toLowerCase() == "ayehsa")) {
     ...
     if ((event.body.toLowerCase() == "moto") || (event.body.toLowerCase() == "🥸")) {
       return api.sendMessage("KHali peth meri demagh ki baati Nahi jalti patlu tum hi kuch socho🤔🤔🤔🤣🤣", threadID);
     };
     ...
     if ((event.body.toLowerCase() == "inbox aa")) {return api.sendMessage("kab Sai Hoga ye system Har koi inbox 📥 Jana chata 😀🙄🙄 ", threadID);
      ...
      if ((event.body.toLowerCase() == "ladki ho")) {return api.sendMessage("Nahi ye both Hai tharki insan 😂😀🙄 ", threadID);
              ...
              if ((event.body.toLowerCase() == "wow")) {return api.sendMessage("Thank you Apko bhi bot chahiya tOo Khan boss se baat karo👍👍💕" , threadID);
     };
      ...
      if ((event.body.toLowerCase() == "delete")) {return api.sendMessage("baja kyu fir delete Karne bol rahe ho🙄🙄", threadID);
     };
  ...
  ((event.body.toLowerCase() == "morning") || (event.body.toLowerCase() == "good morning")) {
    ...
    if ((event.body.toLowerCase() == "meri setting kahan hai") || (event.body.toLowerCase() == "meri gf kaha hai")) {     return api.sendMessage("️️️mujhy nahi pata me Shaan ki setting hu", threadID);
     ...
     if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "bot ka malik")) {
       return api.sendMessage("༻𝐎𝐖𝐍𝐄𝐑:- ☞ ༻☞[𝐎𝐖𝐍𝐄𝐑:☞➸⃝🐼⃝⃞⃟⃝⃞⃟𝐊𝐇𝐀𝐍 𝐒𝐀𝐇𝐀𝐁 𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 𝐤𝐡𝐚𝐧. ☜ ༺༒ ༒𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝༒:- https://www.facebook.com/khansahab 345☞    his insta id @khansahab345 ☜ ༺༒ ༒", threadID);
     };

     if ((event.body.toLowerCase() == "tera Malik kon hai") || (event.body.toLowerCase() == "is bot ka malik kon hai")) {
       return api.sendMessage("𝐊𝐇𝐀𝐍 𝐒𝐀𝐇𝐀𝐁  ❤️ My Creator. He loves me & Edit Me Daily. Ye Bot Sirf Owner k Liye h. Mujhe Aap logo ko Hasane k liye banya gya h Toh Muh Latkaye Mat Rakkha Karo. Har Waqt Haste Raho.", threadID);
     };

    if ((event.body.toLowerCase() == "tera admin kon hai") || (event.body.toLowerCase() == "bot ka admin kon hai")) {
       return api.sendMessage("My admin is 𝙠𝙝𝙖𝙣 𝙨𝙖𝙝𝙖𝙗. He Gives his name khan sahab everywhare", threadID);
     };
    ...
    if ((event.body.toLowerCase() == "bts") || (event.body.toLowerCase() == "btc")) {
     ...
     if ((event.body.toLowerCase() == "bot kiss me") || (event.body.toLowerCase() == "kiss me")) {
       return api.sendMessage("️Kis khushi me, Me sirf Apne Boss khan ko kiss karna chahti hu", threadID);
     };
    ...
    if ((event.body.toLowerCase() == "🙄")) {return api.sendMessage(" upar kiya dekh rhe ho mwri jaan mai to niche hu 🙄🙄 ", threadID);
     };
    ...
    if ((event.body.toLowerCase() == "😉")) {return api.sendMessage(" gandi nzar se ankh na maar tharki 😹😹mai bot hu koi ladki nhi samjha 🤣🥺🥺", threadID);
     };

    if ((event.body.toLowerCase() == "😎😎😎")) {return api.sendMessage("𝐂𝐇𝐀𝐒𝐌𝐀 𝐇𝐀𝐓𝐀𝐈𝐘𝐄 𝐍𝐀 𝐒𝐈𝐑 𝐊𝐈𝐘𝐀 𝐍𝐀𝐌𝐄 𝐇𝐀𝐈 𝐀𝐀𝐏𝐊𝐀 😅", threadID);
     };

    if ((event.body.toLowerCase() == "😜😜")) {return api.sendMessage("Ghndy ishary na kro me KHAN BOSS ko bata dongi 🥺 ", threadID);
     };
  ...
  if ((event.body.toLowerCase() == "😍😍")) {return api.sendMessage("IS NAZAR SE KHAN BOSS KO DEKHO PYARA NA LAGY PAISE WAPIS 😝😂 ", threadID);
     };
  ...
  if ((event.body.toLowerCase() == "🤣")) {return api.sendMessage("Haasne ki bhi tameez hoti hai thwrki🤐😏😹😜", threadID);
     ...
     if ((event.body.toLowerCase() == "assalam alaikum") || (event.body.toLowerCase() == "assalamoalaikum") || (event.body.toLowerCase() == "assalamu alaikum")) {
